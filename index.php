...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Market Access &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Market Access<span></span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">073456789</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="sharon@gmail.com" style="color:white">sharon@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>Market Access</b></span>
				Market Access is e-commerce trading platform for farmers
			</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
										...
										<div class="radio-option">
				                            ...
				                            <label for="buyer">Retailer</label>
				                        </div>
				                        <div class="radio-option">
                                        <input type="radio" id="admin" name="category" value="3" >
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <div class="radio-option">
			                            <input type="radio" id="farmer_signup" name="category" value="1"checked >
			                            <label for="farmer_signup">Farmer</label>
			                        
			                        </div>
									<div class="radio-option">
			                            <input type="radio" id="buyer_signup" name="category" value="2" >
			                            <label for="buyer_signup">Retailer</label>
			                        
			                        </div>
									<div class="radio-option">
                                   <input type="radio" id="admin_signup" name="category" value="3">
